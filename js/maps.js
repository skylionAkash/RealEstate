...
function drawInfoWindow(property) {
  ...
  ibContent =
    ...
    Beds +
    " Bed</span> " +
    "<span><i class='flaticon-holidays'></i>  " +
    bathroom +
    " Bath</span> " +
    "<span><i class='flaticon-vehicle'></i>    " +
    garage +
    " Garages</span> " +
    "</div>" +
    "<div class='map-properties-btns'><a href='properties-details.html' class='border-button-sm border-button-theme' style='margin-right:5px;'>$" +
    price +
    "</a><a href='properties-details.html' class='button-sm button-theme'>Details</a></div>" +
    "</div>";
  return ibContent;
}
...
function insertPropertyToArray(property, layout) {
  ...
  if (layout == "grid_layout") {
    element =
      '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 property-hover" id="' +
      property.id +
      '"><div class="property">\n' +
      "                            <!-- Property img -->\n" +
      '                            <div class="property-img">\n' +
      is_featured +
      '                                <div class="property-tag button sale">For ' +
      listing_for +
      "</div>\n" +
    ...
    element =
      '<div class="property row g-0 fp2 clearfix property-hover" id="' +
      property.id +
      '">\n' +
